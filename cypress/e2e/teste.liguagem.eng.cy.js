...
describe('teste da tela de login da pagina facebook inglês', () => {
  beforeEach(() => {
    cy.visit('pt-br.facebook.com/')
    cy.contains('English (US)').click()
    cy.fixture('linguagem.eng.json')
            .then(function (value) {
                this.linguagem = value
            })
  })
  
  it('verificar se os textos da pagina do facebook estao em inglês', function(){
  ...
  it('verificar se os inputs da pagina do facebook estão em inglês', function(){
      cy.get('#email')
